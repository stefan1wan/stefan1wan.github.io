...
* **Costom the Opencore**
    ...
    1. The files tree. This picture show all the file needed to copy into the usb's first partition. (Especially attention EFI folder itself is also needed.)![]( /images/posts/Hackintosh/opencore_tree.png)
